	...
	$scope.fakeDB={	
		...
		jobs:[{	
			...
			info:{	en:'Last few months after I have moved in Germany, I spent learning German and techs of modern web. I read a lot of tutorial and books. I made a great progress in field of JavaScript, HTML5, CSS3, AngularJS and Sass. I had time to experiment with various technologies. Learn something about Design, Typograhy, Color Theory. I also tried Python. It was a fancy time, in which I developed myself.',
					de:'In den ersten Monaten in Deutschland absolvierte ich einen intensiven Deutschkurs (5x 4h wöchentlich) und arbeitete gleichzeitig per Home Office für die Firma Gratex. Im März entschied ich mich meine langjährige Arbeitstätigkeit bei Gratex einzustellen (ich bin für diese Erfahrung sehr dankbar) um sich voll auf den Deutschkurs, den Web und die Arbeitssuche in Deutschland konzentrieren zu können. In dieser Zeit konnte ich meine Fähigkeiten in HTML5 und CSS3 wesentlich verbessern. Ich machte auch Fortschritte in JS, probierte verschiede Frameworks aus und fing mit dem Lernen von AngularJS an. Ich erstellte auch meinen ersten Responsive Web und dieses Portfolio. Da ich große Freude und Interesse an der Entwicklung mit Gefühl für Design habe, studierte ich die Grundlagen des Webdesigns, der Typografie und Farbentheorie. Später widmete ich mich auch CSS3 Präprozessor Sass und schnupperte kurz an Python. Es ist die Zeit gekommen, all meine Erfahrungen und Kenntnisse in die Praxis umzusetzen.',
			...
			info:{	en:"In the february 2013 I returned from the Australia and continued work on the australian projects. But after few days back home everything changed. We wanted to develop new generation of insurance product and the developers with know-how were needed. I had enough know-how and java experience, so I chose to become a developer again. It was a nice new start. I learned and mastered lot of new skills (Java, MongoDB, GIT, Groovy, JavaScript ...) and in combination with my analysis skills it was pleasure to code. I participated on the whole development process, mainly on the business backend, but also wrote few lines of the framework code. And as the guy with know-how I designed lot of UI/UX features. But after lot of design meetings and first lines of JS code I understood, that I want to participate on creation of code more than on the analysis. I started learn JS and did few MongoDB courses. Finally I decided not to move to Australia, also because my girlfriend got a job in Germany. I started again learn german language and in December moved to Germany, to beautiful city of Freiburg. I remotely continued work for Gratex International till March.",
					de:"Im Februar 2013 kehrte ich von meinem 3-monatigen Arbeitsaufenthalt in Australien zurück. In der Slowakei arbeitete ich weiter an australischen Projekten und in Kürze wurde ich wieder zu einem Developer. Da wir an der Entwicklung einer neuen Generation eines Versicherungsinformationssystems arbeiteten, brauchten wir das Developer Know-How und ich war einer mit diesem Wissen. Ich entdeckte wieder die Schönheit vom Kodieren, was eine angenehme Abwechslung nach all den Spezifikationen war. Ich nutzte meine Kenntnisse aus OOP und Java und verbesserte mich in den Technologien GIT, MongoDB, Groovy, Spock und machte meine erste Erfahrung mit JavaScript.  Während dieser Zeit programmierte ich Geschäftsschichten IS und entwickelte UI. Ab und zu programmierte ich auch etwas in JS, MongooseJS oder Bash und half bei Frameworks mit. Mit der Zeit wurde mir klar, dass ich mehr Zeit in die Entwicklung des Front-Ends und in das eigentliche Design investieren will. Meine Freundin fand währenddessen eine Arbeit in Deutschland als Landschaftsarchitektin und so entschied ich mich das Angebot in Australien zu arbeiten nicht wahrzunehmen. Stattdessen fing ich Deutsch und JS lernen an.",
			...
			info:{	en:"At the end of the october 2012 I got a offer to work for Gratex International AUST in Sydney, Australia. They needed help and I was the first choice in my current company. I couldn't say 'no'. I had to leave in two weeks, so the 5th of November I landed in Sydney. I had only few days to became a valid part of the team. Then I was responsible for new part of insurance system and I also had to teach new analyst.  I spent most of the time in the work (even didn't have a chance to see kangaroo) with editing of the analysis, communication with customers and developers and testing the app. I mainly worked with UML2.0, BPMN, MS Word and also did few presentations. At the end of this journey I got the offer for 2 years fulltime job.",
					de:"Ende Oktober 2012 bekam ich ein Angebot für 3 Monate nach Sydney in Australien arbeiten zu gehen. Natürlich konnte ich nicht nein sagen, auch wenn ich meine Freundin und meine Familie vermisst hatte. In zwei Wochen war ich schon in Sydney und hatte zunächst ein paar Tage Zeit um das Team kennenzulernen und mit der Analyse des neuen Versicherungsinformationssystem loszulegen. Am Anfang wurde mir noch ein Neuling zugewiesen welchen ich einarbeiten sollte. Die meiste in AU verbrachte ich mit Arbeiten (ich habe auch kein Känguru gesehen). Ich konnte mein Englisch verbessern indem ich mit Kunden und anderen Entwicklern kommunizierte. Der Kern der Arbeit war die Spezifikationsbearbeitung, die ich auf Unterschrift vorbereitete. Dazu kam Vorbereitung von Präsentationen und unterschiedlichen Diagrammen in UML2.0 und BPMN. Am Ende meines Aufenthalts bekam ich das Angebot für weitere 2 Jahre in AU arbeiten zu können.",
			...
			info:{	en:'After the first step in IBM as web developer, I got a chance to work for Gratex International, big slovak IT company. I took this chance and became a software analyst. It was a change, but I had a good knowledge from the University and I wanted to taste the work of Analyst on my own. I spent two years on various international projects (EU, Australia). During this time I was designing workflows, db structure and architecture of the software systems. I mastered the UML2.0, BPMN and various own pseudo languages to described workflows or screens. I also designed UX of user interfaces and helped teammates with SQL. In this period I acquired the experiences with work in various teams from 5 to 40 teammates. For few months I had the chance to lead a small team of 5 people and create reverse analysis of insurance system. Then a job in australian office was offered me. So I had to go :)',
					de:"Nach dem verbrachten Sommer bei IBM wollte ich wissen, was hinter der Entwicklung und Planung von Informationssystemen steckt. Ich wollte meine theoretischen Kenntnisse von der Universität in der Praxis umsetzen und so entschied ich mich für die mittelständische Firma Gratex, wo ich meine meiste außeruniversitäre Zeit verbrachte. Ich kam sofort zum Servicedesign und der Entwicklung von UI screens. Dabei musste ich eine Menge von Spezifikationen durchlesen. In den darauffolgenden 2 Jahren gehörte ich unterschiedlichen Teams an, die aus 4 bis 40 Mitarbeiter bestanden. Ich konnte sogar ein Team mit 5 Mitarbeitern leiten. Ich konnte wesentlich mein Englisch verbessern, da wir die Spezifikationen und Analysen in der englischen Sprache machten. Ich beherrschte vollkommen UML2.0, BPMN und andere Pseudosprachen, die wir projektierten. Ich konnte viele Erfahrungen sammeln und bekam danach das Angebot für die Firma Gratex nach Australien arbeiten zu gehen.",
			...
			info:{	en:"In the summer 2010, during the summer holiday, IBM gave me the first real opportunity to work in IT. Before this job I worked only on the side projects and study assignments. Here I had to communicate in english and solved the real tasks. I was a part of team which created and administered the websites of 'Smarter Planet for whole world. That's the story how I started to work.",
					de:"Im Sommer 2010 bewarb ich mich um eine Praktikumsstelle bei IBM. Ich war überrascht, dass ich ausgewählt wurde und startete somit meine IT-Karriere. In IBM traf viele nette Menschen und einen englischsprechenden Chef. Ich konnte mein Englisch deutlich verbessern, da die Emailkommunikation mit der ganzen Welt verlief. Im Rahmen eines Teams nahm ich an dem Projekt „Smarter Planet“ teil. Aus diesem Praktikum nahm viele Erfahrungen mit und den ersten Eindruck von der Geschäftswelt. Erst im Nachhinein merkte ich, dass dies der Anfang meiner IT-Karriere war.",
